...
const sandwichExtras: MenuExtra[] = [
  ...
  { name: "Tasty Cheese", price: "$1.00" },
  { name: "Avocado/Pineapple", price: "$2.50" },
  { name: "Mashed Egg", price: "$2.90" },
  { name: "Sliced Egg", price: "$2.00" },
...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Burger LOT",
        description:
          "100% Homemade Beef, Cheese, Egg, Bacon, Pineapple, Tomato, Lettuce, Beetroot, Grilled Onion.",
        price: "$16.90",
      },
      {
        id: "salisbury-burger",
      ...
      },
      {
        id: "bulgogi-burger",
        name: "Bulgogi Burger",
        description: "Marinated Beef, Cheese, Lettuce, Onion, Mayo.",
        price: "$14.90",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Add Gravy for $1.50 extra",
        price: "$6.00",
      },
      {
        id: "hot-chips-large",
        name: "Hot Chips (Large)",
        description: "Add Gravy for $2.00 extra",
        price: "$9.00",
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "breakkie-wrap",
        name: "Breakkie Wrap",
        description: "5 Bacon, 2 Eggs, 2 Cheese & Tomato Relish.",
        price: "$12.90",
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ginger-beer", name: "Ginger Beer", price: "$4.50" },
      { id: "monster", name: "Monster", description: "Assorted Flavours.", price: "$5.00" },
      { id: "iced-tea", name: "Iced Tea", description: "Peach or Green Tea.", price: "$4.50" },
      {
        id: "coke-600",
        name: "Coke 600ml",
