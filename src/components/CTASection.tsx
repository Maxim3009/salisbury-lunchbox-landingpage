  ...
  return (
    <section className="bg-primary text-paper">
      <div className="mx-auto max-w-4xl px-6 py-20 text-center lg:py-28">
        ...
        <h2 className="mt-5 font-display text-3xl leading-tight text-balance sm:text-4xl lg:text-5xl">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/menu"
            className="group inline-flex items-center gap-2 bg-accent px-6 py-3.5 text-sm font-semibold text-paper transition-colors hover:bg-accent-dark"
          >
            View Our Menu
