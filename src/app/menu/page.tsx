...
export const metadata: Metadata = {
  title: "Menu",
  description:
    "The full Salisbury Lunch Box menu — burgers, wraps, sandwiches, hot snacks, breakfast, beverages and catering.",
};
    ...
    <div className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
      <div className="flex flex-col gap-4 border-b border-line pb-8 sm:flex-row sm:items-end sm:justify-between">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 text-sm font-semibold text-primary underline decoration-line underline-offset-4 transition-colors hover:text-accent-dark"
        >
      ...
      <div className="mt-10 grid grid-cols-1 gap-8 border border-line bg-paper-soft p-6 sm:grid-cols-2 lg:p-8">
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-primary">
            ...
            <a
              href={restaurant.phoneHref}
              className="font-semibold text-primary underline decoration-line underline-offset-2 hover:text-accent-dark"
            >
              {restaurant.phoneDisplay}
            </a>{" "}
            with:
          </p>
          <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm leading-relaxed text-primary">
        ...
        <div>
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-relaxed text-primary">
